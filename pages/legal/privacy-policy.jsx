      ...
      <main className="mx-auto prose">
        ...
        <ul>
          <li>
            ...
            <a href={HUSTLE.COMPANY.URL}>{HUSTLE.COMPANY.URL}</a>, or any
        ...
        <p>
          ...
          information depending on how you interact with {HUSTLE.COMPANY.NAME}{" "}
        ...
        <p>
          ...
          available here:{" "}
          <a href={HUSTLE.COMPANY.CONTACT_FORM}>
            {HUSTLE.COMPANY.CONTACT_FORM}
          </a>
        ...
        <ul>
          ...
          <li>
            state of the car that may affect services (broken windshield, pet
            hair in car, stains, etc)
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            Privacy Policy, please refer to this link. We use certain Google
            Maps Platform APIs to retrieve certain information when you make
            location-specific requests. This includes: Location; and other
            ...
            &quot;HOW DO WE PROCESS YOUR INFORMATION?&quot;. We obtain and store
            on your device (&quot;cache&quot;) your location. You may revoke
        ...
        <h2 id="what-are-your-privacy-rights-">
        ...
        <p>
          ...
          ascontact_form necessary to stay compliant with relevant laws.
        </p>
        <p>
        ...
        <p>
          ...
          at {HUSTLE.COMPANY.EMAIL} or by post to:
        </p>
        <p>
          {HUSTLE.COMPANY.NAME}
