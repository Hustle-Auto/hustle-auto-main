    ...
    <PageSection>
      <main className="mx-auto prose">
        ...
        <p>
          ...
          <a href={HUSTLE.COMPANY.URL}>{HUSTLE.COMPANY.URL}</a> website as well
        ...
        <p>
          ...
          Terms of Use; (2) you are not a minor in the jurisdiction in which you
          ...
          will not use the Site for any illegal or unauthorized purpose; and (5)
        ...
        <p>
          ...
          Canada. {HUSTLE.COMPANY.NAME} and yourself irrevocably consent that
          the courts of Canada shall have exclusive jurisdiction to resolve any
        ...
        <p>
          ...
          be three (3). The seat, or legal place, of arbitration shall be
          Calgary, Canada. The language of the proceedings shall be English. The
        ...
        <p>
          ...
          OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $20.00 USD. CERTAIN US
